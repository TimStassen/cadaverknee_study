...
def convert2mhd(file_path, or_im_path, output_path):
    ...
    # image_array_fl = np.flip(image_array, axis=0) # MUST BE FLIPPED FOR SOME STRANGE REASON
...
if __name__ == "__main__":
    root_mask_path = r'E:\segmentations PCCT Tim\cartilage_nrrd\30_2017'
    root_mask_dir = os.listdir(root_mask_path)
    root_im_path = r'E:\ME_data_mhd'
    output_path = r'E:\segmentations PCCT Tim\cartilage_PCCT_atlas_flipped'
