...
for registration in registrations_dir:
    ...
    seg_img_dir = os.path.join(segmentation_dir, seg_img_name, seg_img_name + '_' + cartilage + '.mhd') # or mhd if it is converted
    pdb.set_trace()
    ...
    a.apply_transformation(transformation_file_dir, seg_img_dir, fixed_image=None, moving_image=None, transformix_path=transformix_path)
