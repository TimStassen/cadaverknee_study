...
class AnalyzeVolume:
    ...
    def evaluation_metrics(self):
        ...
        # fixed_image = []
        # moving_image = []
        # for pred, GT, fixed_name, moving_name in zip(self.pred, self.GT, self.fixed_img_name, self.moving_img_name):
        fixed_name = self.fixed_img_name
        moving_name = self.moving_img_name
